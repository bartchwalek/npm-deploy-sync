...
class ExecutionController {
    ...
    public constructor(controller: AbortController, childProcessFactory: () => ChildProcessByStdio<Writable, Readable, Readable>) {
...
export class CommandShell {
    ...
    constructor(command: string, flagsPrefix: string = '-', descriptors: ExecutionDescriptors = {} as ExecutionDescriptors) {
